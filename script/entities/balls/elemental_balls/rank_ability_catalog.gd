	...
	match rank:
		...
		5:
			return [
				...
				_ability("giant_orb", 5, "Giant Orb", "One random ball gets ×3 attack damage and ×2 size."),
		...
		7:
			...
			_ability("time_stop", 7, "Time Stop", "Clear all balls from the box. All enemies are frozen in time for 10s — they cannot act and take 50% more damage."),
