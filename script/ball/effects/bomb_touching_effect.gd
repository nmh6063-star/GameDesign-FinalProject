...
func can_trigger(_ctx: BattleContext, _source) -> bool:
	return false


func apply(_ctx: BattleContext, _source) -> void:
	pass
...
func _explode(ctx: BattleContext, source) -> void:
